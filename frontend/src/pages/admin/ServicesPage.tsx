...
export default function AdminServices() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['admin', 'services', search, statusFilter, categoryFilter],
    queryFn: () => adminApi.services({ search, status: statusFilter, category_id: categoryFilter, per_page: 50 }).then(r => r.data),
  });
  ...
  const openEditModal = (service: Service) => {
    ...
    setForm({
      name: service.name,
      slug: service.slug,
      category_id: (service as any).category_id || (service as any).category?.id || '',
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            title="Sync all services & categories from Infiniforge.cloud"
          >
            {isSyncing ? (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                              ...
                              {((s as any).category?.name || categories.find((c: any) => c.id === (s as any).category_id)?.name) && (
