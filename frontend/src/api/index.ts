...
export const adminApi = {
  ...
  createOrder: (data: object) => api.post('/admin/orders', data),
  assignOrder: (id: string, organization_id: string) => api.post(`/admin/orders/${id}/assign`, { organization_id }),
  bulkOrders: (data: { action: string; ids: string[]; status?: string }) => api.post('/admin/orders/bulk-action', data),
  ...
  reportsProducts: (params?: object) => api.get('/admin/reports/products', { params }),
  reportsOrders: (params?: object) => api.get('/admin/reports/orders', { params }),
