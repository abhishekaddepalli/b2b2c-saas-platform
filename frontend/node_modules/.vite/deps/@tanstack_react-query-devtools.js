...
import {
  ...
  render,
  setupStyleSheet
} from "./chunk-P6ZD3PYI.js";
import {
  onlineManager,
  useQueryClient
} from "./chunk-23JFJDUP.js";
import {
  require_jsx_runtime
...
var TanstackQueryDevtools = (_a = class {
  constructor(config) {
    ...
    const { client, queryFlavor, version, onlineManager: onlineManager2, buttonPosition, position, initialIsOpen, errorTypes, styleNonce, shadowDOMTarget, hideDisabledQueries, theme } = config;
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) Devtools = __privateGet(this, _Component);
        ...
        Devtools = lazy(() => import("./DevtoolsComponent-CFsAhafd-PHVGKJV4.js"));
...
var TanstackQueryDevtoolsPanel = (_a2 = class {
  constructor(config) {
    ...
    const { client, queryFlavor, version, onlineManager: onlineManager2, buttonPosition, position, initialIsOpen, errorTypes, styleNonce, shadowDOMTarget, onClose, hideDisabledQueries, theme } = config;
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      let Devtools;
      if (__privateGet(this, _Component2)) Devtools = __privateGet(this, _Component2);
      else {
        Devtools = lazy(() => import("./DevtoolsPanelComponent-B9zkHqmD-AHI3F4GN.js"));
...
function ReactQueryDevtoolsPanel(props) {
  ...
  const [devtools] = React2.useState(new TanstackQueryDevtoolsPanel({
    client: queryClient,
    queryFlavor: "React Query",
    version: "5",
    onlineManager,
